...
namespace Weight_for_weight
{
    class Program
    {
        ...
        // I will modify the order of the list".
        ...
        // is less than the one of 180 (9) and 180 is before 90 since, having the same "weight" (9),
        ...
        private static string OrderWeight(string strng) =>
            string.Join(" ", strng.Split(' ')
                .OrderBy(z => z.ToCharArray().Sum(char.GetNumericValue))
                .ThenBy(x => x));
    }
}
...
namespace Fibonacci_Tribonacci_and_friends
{
    static class Program
    {
        ...
        // sum of the 4 previous, a Pentabonacci (well Cinquebonacci would probably sound
        // a bit more italian, but it would also sound really awful) with a signature
        // of 5 elements and each following element is the sum of the 5 previous, and so on.
        ...
        // of the last X elements - and returns the first n elements of the so seeded sequence.
        ...
        {
            var a = Xbonacci(new double[] {1, 1, 1, 1}, 10);
            var b = Xbonacci(new double[] {0,0,0,0,1}, 10);
            var c = Xbonacci(new double[] {1,0,0,0,0,0,1}, 10);
            var d = Xbonacci(new double[] {1, 1}, 2);
        }

        private static double[] Xbonacci(double[] signature, int n)
        {
            var xbonacci = new double[n];

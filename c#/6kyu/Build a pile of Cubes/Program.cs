...
namespace Build_a_pile_of_Cubes
{
    static class Program
    {
        ...
        {
            Console.WriteLine(FindNb(4183059834009)); // 2022
            Console.WriteLine(FindNb(24723578342962)); // -1
            Console.WriteLine(FindNb(135440716410000)); // 4824
            Console.WriteLine(FindNb(40539911473216)); // 3568
        }
